...
#### stock_zh_a_daily - 新浪财经-沪深京 A 股的数据, 历史数据按日频率更新; 注意其中的 **sh689009** 为 CDR, 请 通过 **ak.stock_zh_a_cdr_daily** 接口获取
- **数据源**: 新浪财经
...
#### stock_analyst_rank_em - 东方财富网-数据中心-研究报告-东方财富分析师指数
- **数据源**: 东方财富网
...
#### stock_board_concept_name_em - 东方财富网-行情中心-沪深京板块-概念板块
- **数据源**: 东方财富网
...
#### stock_board_industry_hist_em - 东方财富-沪深板块-行业板块-历史行情数据
- **数据源**: 东方财富网
...
#### stock_board_industry_name_em - 东方财富-沪深京板块-行业板块
- **数据源**: 东方财富网
- **功能**: 东方财富-沪深京板块-行业板块
...
#### stock_cg_lawsuit_cninfo - 巨潮资讯-数据中心-专题统计-公司治理-公司诉讼
- **数据源**: 未明确说明
...
#### stock_comment_detail_scrd_desire_em - 东方财富网-数据中心-特色数据-千股千评-市场热度-市场参与意愿
- **数据源**: 东方财富网
...
#### stock_dzjy_hygtj - 东方财富网-数据中心-大宗交易-活跃 A 股统计
- **数据源**: 东方财富网
...
#### stock_dzjy_mrtj - 东方财富网-数据中心-大宗交易-每日统计
- **数据源**: 东方财富网
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-股东分析-股东持股变动统计-十大股东
- **限量**: 单次返回指定 date 的所有数据
- **输入参数**: 
  - `date` (`str`): date="20210930"; 财报发布季度最后日
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-股东分析-股东持股明细-十大股东
- **限量**: 单次返回指定参数的所有数据
- **输入参数**: 
...
#### stock_ggcg_em - 东方财富网-数据中心-特色数据-高管持股
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-高管持股
- **限量**: 单次获取所有高管持股数据数据
- **输入参数**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股权质押-质押机构分布统计-银行
- **限量**: 单次返回当前时点所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股权质押-质押机构分布统计-证券公司
- **限量**: 单次返回当前时点所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股权质押-上市公司质押比例-行业数据
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股权质押-重要股东股权质押明细
...
#### stock_gpzy_pledge_ratio_em - 东方财富网-数据中心-特色数据-股权质押-上市公司质押比例
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股权质押-上市公司质押比例
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股权质押-股权质押市场概况
- **限量**: 单次所有历史数据, 由于数据量比较大需要等待一定时间
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_history_dividend_detail - 新浪财经-发行与分配-分红配股
- **数据源**: 新浪财经
- **功能**: 新浪财经-发行与分配-分红配股
...
#### stock_hk_hot_rank_detail_em - 东方财富网-股票热度-历史趋势
- **数据源**: 东方财富网
- **功能**: 东方财富网-股票热度-历史趋势
...
#### stock_hk_hot_rank_detail_realtime_em - 东方财富网-个股人气榜-实时变动
- **数据源**: 东方财富网
- **功能**: 东方财富网-个股人气榜-实时变动
- **限量**: 单次返回指定 symbol 的股票近期历史数据
- **输入参数**: 
...
#### stock_hold_control_cninfo - 巨潮资讯-数据中心-专题统计-股东股本-实际控制人持股变动
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据中心-专题统计-股东股本-实际控制人持股变动
...
#### stock_hold_management_detail_cninfo - 巨潮资讯-数据中心-专题统计-股东股本-高管持股变动明细
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据中心-专题统计-股东股本-高管持股变动明细
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-高管持股-董监高及相关人员持股变动明细
- **限量**: 单次返回所有数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-高管持股-人员增减持股变动明细
...
#### stock_hold_num_cninfo - 巨潮资讯-数据中心-专题统计-股东股本-股东人数及持股集中度
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据中心-专题统计-股东股本-股东人数及持股集中度
...
#### stock_hot_deal_xq - 雪球-沪深股市-热度排行榜-交易排行榜
- **数据源**: 雪球
- **功能**: 雪球-沪深股市-热度排行榜-交易排行榜
...
#### stock_hot_keyword_em - 东方财富-个股人气榜-热门关键词
- **数据源**: 东方财富网
- **功能**: 东方财富-个股人气榜-热门关键词
...
#### stock_hot_rank_detail_em - 东方财富网-股票热度-历史趋势及粉丝特征
- **数据源**: 东方财富网
- **功能**: 东方财富网-股票热度-历史趋势及粉丝特征
- **限量**: 单次返回指定 symbol 的股票近期历史数据
- **输入参数**: 
  - `symbol` (`str`): symbol="SZ000665"
- **返回字段**: 
...
#### stock_hot_rank_detail_realtime_em - 东方财富网-个股人气榜-实时变动
- **数据源**: 东方财富网
- **功能**: 东方财富网-个股人气榜-实时变动
- **限量**: 单次返回指定 symbol 的股票近期历史数据
- **输入参数**: 
...
#### stock_individual_basic_info_xq - 雪球财经-个股-公司概况-公司简介
- **数据源**: 雪球
...
#### stock_individual_fund_flow - 东方财富网-数据中心-个股资金流向
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-个股资金流向
...
#### stock_individual_fund_flow_rank - 东方财富网-数据中心-资金流向-排名
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-资金流向-排名
...
#### stock_industry_category_cninfo - 巨潮资讯-数据-行业分类数据
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据-行业分类数据
...
#### stock_industry_change_cninfo - 巨潮资讯-数据-上市公司行业归属的变动情况
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据-上市公司行业归属的变动情况
...
#### stock_info_bj_name_code - 北京证券交易所股票代码和简称数据
- **数据源**: 北京证券交易所
- **功能**: 北京证券交易所股票代码和简称数据
...
#### stock_info_change_name - 新浪财经-股票曾用名
- **数据源**: 新浪财经
- **功能**: 新浪财经-股票曾用名
...
#### stock_info_sh_delist - 上海证券交易所暂停/终止上市股票
- **数据源**: 上海证券交易所
- **功能**: 上海证券交易所暂停/终止上市股票
...
#### stock_info_sh_name_code - 上海证券交易所股票代码和简称数据
- **数据源**: 上海证券交易所
- **功能**: 上海证券交易所股票代码和简称数据
...
#### stock_info_sz_change_name - 深证证券交易所-市场数据-股票数据-名称变更
- **数据源**: 深圳证券交易所
- **功能**: 深证证券交易所-市场数据-股票数据-名称变更
- **限量**: 单次获取所有历史数据
- **输入参数**: 
...
#### stock_info_sz_delist - 深证证券交易所终止/暂停上市股票
- **数据源**: 深圳证券交易所
- **功能**: 深证证券交易所终止/暂停上市股票
...
#### stock_info_sz_name_code - 深证证券交易所股票代码和股票简称数据
- **数据源**: 深圳证券交易所
- **功能**: 深证证券交易所股票代码和股票简称数据
...
#### stock_institute_hold - 新浪财经-机构持股-机构持股一览表
- **数据源**: 新浪财经
- **功能**: 新浪财经-机构持股-机构持股一览表
- **限量**: 单次获取所有历史数据
- **输入参数**: 
...
#### stock_institute_hold_detail - 新浪财经-机构持股-机构持股详情
- **数据源**: 新浪财经
- **功能**: 新浪财经-机构持股-机构持股详情
- **限量**: 单次所有历史数据
- **输入参数**: 
...
#### stock_institute_recommend - 新浪财经-机构推荐池-具体指标的数据
- **数据源**: 新浪财经
- **功能**: 新浪财经-机构推荐池-具体指标的数据
...
#### stock_institute_recommend_detail - 新浪财经-机构推荐池-股票评级记录
- **数据源**: 新浪财经
- **功能**: 新浪财经-机构推荐池-股票评级记录
...
#### stock_ipo_declare - 东方财富网-数据中心-新股申购-首发申报信息-首发申报企业信息
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股申购-首发申报信息-首发申报企业信息
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_ipo_info - 新浪财经-发行与分配-新股发行
- **数据源**: 新浪财经
- **功能**: 新浪财经-发行与分配-新股发行
- **限量**: 单次获取新股发行的基本信息数据
- **输入参数**: 
...
#### stock_jgdy_detail_em - 东方财富网-数据中心-特色数据-机构调研-机构调研详细
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-机构调研-机构调研详细
- **限量**: 单次所有历史数据, 由于数据量比较大需要等待一定时间
- **输入参数**: 
...
#### stock_jgdy_tj_em - 东方财富网-数据中心-特色数据-机构调研-机构调研统计
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-机构调研-机构调研统计
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_lh_yyb_capital - 龙虎榜-营业部排行-资金实力最强
- **数据源**: 同花顺
- **功能**: 龙虎榜-营业部排行-资金实力最强
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_lh_yyb_control - 龙虎榜-营业部排行-抱团操作实力
- **数据源**: 同花顺
- **功能**: 龙虎榜-营业部排行-抱团操作实力
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_lh_yyb_most - 龙虎榜-营业部排行-上榜次数最多
- **数据源**: 同花顺
- **功能**: 龙虎榜-营业部排行-上榜次数最多
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_lhb_detail_daily_sina - 新浪财经-龙虎榜-每日详情
- **数据源**: 新浪财经
- **功能**: 新浪财经-龙虎榜-每日详情
- **限量**: 单次返回指定 date 的所有数据
- **输入参数**: 
...
#### stock_lhb_ggtj_sina - 新浪财经-龙虎榜-个股上榜统计
- **数据源**: 新浪财经
- **功能**: 新浪财经-龙虎榜-个股上榜统计
...
#### stock_lhb_jgmx_sina - 新浪财经-龙虎榜-机构席位成交明细
- **数据源**: 新浪财经
- **功能**: 新浪财经-龙虎榜-机构席位成交明细
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_lhb_jgzz_sina - 新浪财经-龙虎榜-机构席位追踪
- **数据源**: 新浪财经
- **功能**: 新浪财经-龙虎榜-机构席位追踪
- **限量**: 单次返回指定 symbol 的所有历史数据
- **输入参数**: 
...
#### stock_lhb_yyb_detail_em - 东方财富网-数据中心-龙虎榜单-营业部历史交易明细-营业部交易明细
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-龙虎榜单-营业部历史交易明细-营业部交易明细
- **限量**: 单次返回指定营业部的所有历史数据
- **输入参数**: 
...
#### stock_lhb_yytj_sina - 新浪财经-龙虎榜-营业上榜统计
- **数据源**: 新浪财经
- **功能**: 新浪财经-龙虎榜-营业上榜统计
- **限量**: 单次返回指定 symbol 的所有历史数据
- **输入参数**: 
...
#### stock_lrb_em - 东方财富-数据中心-年报季报-业绩快报-利润表
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩快报-利润表
...
#### stock_main_fund_flow - 东方财富网-数据中心-资金流向-主力净流入排名
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-资金流向-主力净流入排名
...
#### stock_main_stock_holder - 新浪财经-股本股东-主要股东
- **数据源**: 新浪财经
- **功能**: 新浪财经-股本股东-主要股东
- **限量**: 单次获取所有历史数据
- **输入参数**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-融资融券-融资融券账户统计-两融账户信息
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_margin_detail_sse - 上海证券交易所-融资融券数据-融资融券明细数据
- **数据源**: 上海证券交易所
- **功能**: 上海证券交易所-融资融券数据-融资融券明细数据
- **限量**: 单次返回交易日的所有历史数据
- **输入参数**: 
...
#### stock_margin_detail_szse - 深证证券交易所-融资融券数据-融资融券交易明细数据
- **数据源**: 深圳证券交易所
- **功能**: 深证证券交易所-融资融券数据-融资融券交易明细数据
...
#### stock_margin_sse - 上海证券交易所-融资融券数据-融资融券汇总数据
- **数据源**: 上海证券交易所
- **功能**: 上海证券交易所-融资融券数据-融资融券汇总数据
...
#### stock_margin_szse - 深圳证券交易所-融资融券数据-融资融券汇总数据
- **数据源**: 深圳证券交易所
- **功能**: 深圳证券交易所-融资融券数据-融资融券汇总数据
- **限量**: 单次返回指定时间内的所有历史数据
- **输入参数**: 
...
#### stock_margin_underlying_info_szse - 深圳证券交易所-融资融券数据-标的证券信息
- **数据源**: 深圳证券交易所
- **功能**: 深圳证券交易所-融资融券数据-标的证券信息
- **限量**: 单次返回交易日的所有历史数据
- **输入参数**: 
  - `date` (`str`): date="20210205"
- **返回字段**: 
...
#### stock_market_activity_legu - 乐咕乐股网-赚钱效应分析数据
- **数据源**: 乐咕乐股
- **功能**: 乐咕乐股网-赚钱效应分析数据
- **限量**: 单次返回当前赚钱效应分析数据
- **输入参数**: 
...
#### stock_new_a_spot_em - 东方财富网-新股-实时行情数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-新股-实时行情数据
...
#### stock_news_main_cx - 财新网-财新数据通-内容精选
- **数据源**: 财新网
- **功能**: 财新网-财新数据通-内容精选
- **限量**: 返回所有历史新闻数据
- **输入参数**: 
...
#### stock_profit_forecast_em - 东方财富网-数据中心-研究报告-盈利预测; 该数据源网页端返回数据有异常, 本接口已修复该异常
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-研究报告-盈利预测; 该数据源网页端返回数据有异常, 本接口已修复该异常
...
#### stock_profit_forecast_ths - 同花顺-盈利预测
- **数据源**: 未明确说明
- **功能**: 同花顺-盈利预测
- **限量**: 单次返回指定 symbol 和 indicator 的数据
- **输入参数**: 
...
#### stock_rank_forecast_cninfo - 巨潮资讯-数据中心-评级预测-投资评级
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据中心-评级预测-投资评级
- **限量**: 单次获取指定交易日的所有数据
- **输入参数**: 
  - `date` (`str`): date="20210910"; 交易日
- **返回字段**: 
...
#### stock_rank_xstp_ths - 同花顺-数据中心-技术选股-向上突破
- **数据源**: 同花顺
- **功能**: 同花顺-数据中心-技术选股-向上突破
- **限量**: 单次返回所有数据
- **输入参数**: 
...
#### stock_rank_xxtp_ths - 同花顺-数据中心-技术选股-向下突破
- **数据源**: 同花顺
- **功能**: 同花顺-数据中心-技术选股-向下突破
- **限量**: 单次返回所有数据
- **输入参数**: 
  - `symbol` (`str`): symbol="500日均线"; choice of {"5日均线", "10日均线", "20日均线", "30日均线", "60日均线", "90日均线", "250日均线", "500日均线"}
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-IPO审核信息-北交所
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-IPO审核信息-创业板
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_register_db - 东方财富网-数据中心-新股数据-注册制审核-达标企业
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-注册制审核-达标企业
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-IPO审核信息-上海主板
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-IPO审核信息-深圳主板
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_report_disclosure - 巨潮资讯-数据-预约披露的数据
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据-预约披露的数据
...
#### stock_report_fund_hold - 东方财富网-数据中心-主力数据-基金持仓
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-主力数据-基金持仓
...
#### stock_report_fund_hold_detail - 东方财富网-数据中心-主力数据-基金持仓-基金持仓明细表
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-主力数据-基金持仓-基金持仓明细表
- **限量**: 单次返回指定 symbol 和 date 的所有历史数据
- **输入参数**: 
...
#### stock_research_report_em - 东方财富网-数据中心-研究报告-个股研报
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-研究报告-个股研报
...
#### stock_restricted_release_queue_sina - 新浪财经-发行分配-限售解禁
- **数据源**: 新浪财经
- **功能**: 新浪财经-发行分配-限售解禁
...
#### stock_sector_detail - 新浪行业-板块行情-成份详情, 由于新浪网页提供的统计数据有误, 部分行业数量大于统计数
- **数据源**: 新浪财经
- **功能**: 新浪行业-板块行情-成份详情, 由于新浪网页提供的统计数据有误, 部分行业数量大于统计数
...
#### stock_sector_fund_flow_hist - 东方财富网-数据中心-资金流向-行业资金流-行业历史资金流
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-资金流向-行业资金流-行业历史资金流
...
#### stock_sector_fund_flow_rank - 东方财富网-数据中心-资金流向-板块资金流-排名
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-资金流向-板块资金流-排名
...
#### stock_sector_fund_flow_summary - 东方财富网-数据中心-资金流向-行业资金流-xx行业个股资金流
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-资金流向-行业资金流-xx行业个股资金流
...
#### stock_sh_a_spot_em - 东方财富网-沪 A 股-实时行情数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-沪 A 股-实时行情数据
...
#### stock_share_change_cninfo - 巨潮资讯-数据-公司股本变动
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-数据-公司股本变动
- **限量**: 单次获取指定 symbol 在 start_date 和 end_date 之间的公司股本变动数据
- **输入参数**: 
...
#### stock_share_hold_change_bse - 北京证券交易所-信息披露-监管信息-董监高及相关人员持股变动
- **数据源**: 北京证券交易所
- **功能**: 北京证券交易所-信息披露-监管信息-董监高及相关人员持股变动
- **限量**: 单次获取指定 symbol 的数据
- **输入参数**: 
...
#### stock_share_hold_change_sse - 上海证券交易所-披露-监管信息公开-公司监管-董董监高人员股份变动
- **数据源**: 上海证券交易所
- **功能**: 上海证券交易所-披露-监管信息公开-公司监管-董董监高人员股份变动
- **限量**: 单次获取指定 symbol 的数据
- **输入参数**: 
...
#### stock_share_hold_change_szse - 深圳证券交易所-信息披露-监管信息公开-董监高人员股份变动
- **数据源**: 深圳证券交易所
- **功能**: 深圳证券交易所-信息披露-监管信息公开-董监高人员股份变动
- **限量**: 单次获取指定 symbol 的数据
- **输入参数**: 
...
#### stock_sse_deal_daily - 上海证券交易所-数据-股票数据-成交概况-股票成交概况-每日股票情况
- **数据源**: 上海证券交易所
- **功能**: 上海证券交易所-数据-股票数据-成交概况-股票成交概况-每日股票情况
...
#### stock_sy_em - 东方财富网-数据中心-特色数据-商誉-个股商誉明细
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-商誉-个股商誉明细
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_sy_hy_em - 东方财富网-数据中心-特色数据-商誉-行业商誉
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-商誉-行业商誉
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_sy_jz_em - 东方财富网-数据中心-特色数据-商誉-个股商誉减值明细
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-商誉-个股商誉减值明细
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_sy_yq_em - 东方财富网-数据中心-特色数据-商誉-商誉减值预期明细
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-商誉-商誉减值预期明细
- **限量**: 单次所有历史数据
- **输入参数**: 
...
#### stock_sz_a_spot_em - 东方财富网-深 A 股-实时行情数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-深 A 股-实时行情数据
...
#### stock_szse_sector_summary - 深圳证券交易所-统计资料-股票行业成交数据
- **数据源**: 深圳证券交易所
...
#### stock_tfp_em - 东方财富网-数据中心-特色数据-停复牌信息
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-停复牌信息
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-估值分析-每日互动-每日互动-估值分析
- **限量**: 单次获取指定 symbol 的所有历史数据
- **输入参数**: 
...
#### stock_xgsglb_em - 东方财富网-数据中心-新股数据-新股申购-新股申购与中签查询
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-新股申购-新股申购与中签查询
...
#### stock_xjll_em - 东方财富-数据中心-年报季报-业绩快报-现金流量表
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩快报-现金流量表
...
#### stock_yjbb_em - 东方财富-数据中心-年报季报-业绩报表
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩报表
...
#### stock_yjkb_em - 东方财富-数据中心-年报季报-业绩快报
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩快报
...
#### stock_yjyg_em - 东方财富-数据中心-年报季报-业绩预告
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩预告
...
#### stock_yysj_em - 东方财富-数据中心-年报季报-预约披露时间
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-预约披露时间
...
#### stock_yzxdr_em - 东方财富网-数据中心-特色数据-一致行动人
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-一致行动人
- **限量**: 单次返回所有历史数据
- **输入参数**: 
...
#### stock_zcfz_bj_em - 东方财富-数据中心-年报季报-业绩快报-资产负债表
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩快报-资产负债表
...
#### stock_zcfz_em - 东方财富-数据中心-年报季报-业绩快报-资产负债表
- **数据源**: 东方财富网
- **功能**: 东方财富-数据中心-年报季报-业绩快报-资产负债表
- **限量**: 单次获取指定 date 的资产负债表数据
- **输入参数**: 
...
#### stock_zdhtmx_em - 东方财富网-数据中心-重大合同-重大合同明细
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-重大合同-重大合同明细
...
#### stock_zh_a_disclosure_relation_cninfo - 巨潮资讯-首页-公告查询-信息披露调研-沪深京
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-首页-公告查询-信息披露调研-沪深京
...
#### stock_zh_a_disclosure_report_cninfo - 巨潮资讯-首页-公告查询-信息披露公告-沪深京
- **数据源**: 未明确说明
- **功能**: 巨潮资讯-首页-公告查询-信息披露公告-沪深京
...
#### stock_zh_a_gdhs - 东方财富网-数据中心-特色数据-股东户数数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股东户数数据
- **限量**: 单次获取返回所有数据
- **输入参数**: 
...
#### stock_zh_a_gdhs_detail_em - 东方财富网-数据中心-特色数据-股东户数详情
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-股东户数详情
- **限量**: 单次获取指定 symbol 的所有数据
- **输入参数**: 
  - `symbol` (`str`): symbol="000001"; 股票代码
- **返回字段**: 
...
#### stock_zh_a_hist_pre_min_em - 东方财富-股票行情-盘前数据
- **数据源**: 东方财富网
- **功能**: 东方财富-股票行情-盘前数据
...
#### stock_zh_a_hist_tx - 腾讯证券-日频-股票历史数据; 历史数据按日频率更新, 当日收盘价请在收盘后获取
- **数据源**: 未明确说明
- **功能**: 腾讯证券-日频-股票历史数据; 历史数据按日频率更新, 当日收盘价请在收盘后获取
- **限量**: 单次返回指定沪深京 A 股上市公司、指定周期和指定日期间的历史行情日频率数据
- **输入参数**: 
...
#### stock_zh_a_tick_tx_js - 每个交易日 16:00 提供当日数据; 如遇到数据缺失, 请使用 **ak.stock_zh_a_tick_163()** 接口(注意数据会有一定差异)
- **数据源**: 未明确说明
- **功能**: 每个交易日 16:00 提供当日数据; 如遇到数据缺失, 请使用 **ak.stock_zh_a_tick_163()** 接口(注意数据会有一定差异)
- **限量**: 单次返回最近交易日的历史分笔行情数据
- **输入参数**: 
  - `symbol` (`str`): symbol="sz000001"; 默认值为 "sz000001"
- **返回字段**: 
  - `成交时间` (`object`): -
  - `成交价格` (`float64`): 注意单位: 元
  - `价格变动` (`float64`): 注意单位: 元
...
#### stock_zh_ah_daily - 腾讯财经-A+H 股数据
- **数据源**: 未明确说明
- **功能**: 腾讯财经-A+H 股数据
...
#### stock_zh_ah_name - A+H 股数据是从腾讯财经获取的数据, 历史数据按日频率更新
- **数据源**: 未明确说明
- **功能**: A+H 股数据是从腾讯财经获取的数据, 历史数据按日频率更新
...
#### stock_zh_ah_spot - A+H 股数据是从腾讯财经获取的数据, 延迟 15 分钟更新
- **数据源**: 未明确说明
- **功能**: A+H 股数据是从腾讯财经获取的数据, 延迟 15 分钟更新
...
#### stock_zh_b_daily - B 股数据是从新浪财经获取的数据, 历史数据按日频率更新
- **数据源**: 新浪财经
- **功能**: B 股数据是从新浪财经获取的数据, 历史数据按日频率更新
...
#### stock_zh_b_minute - 新浪财经 B 股股票或者指数的分时数据，目前可以获取 1, 5, 15, 30, 60 分钟的数据频率, 可以指定是否复权
- **数据源**: 新浪财经
- **功能**: 新浪财经 B 股股票或者指数的分时数据，目前可以获取 1, 5, 15, 30, 60 分钟的数据频率, 可以指定是否复权
...
#### stock_zh_b_spot - B 股数据是从新浪财经获取的数据, 重复运行本函数会被新浪暂时封 IP, 建议增加时间间隔
- **数据源**: 新浪财经
- **功能**: B 股数据是从新浪财经获取的数据, 重复运行本函数会被新浪暂时封 IP, 建议增加时间间隔
...
#### stock_zh_b_spot_em - 东方财富网-实时行情数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-实时行情数据
- **限量**: 单次返回所有 B 股上市公司的实时行情数据
- **输入参数**: 
...
#### stock_zt_pool_dtgc_em - 东方财富网-行情中心-涨停板行情-跌停股池
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-涨停板行情-跌停股池
...
#### stock_zt_pool_em - 东方财富网-行情中心-涨停板行情-涨停股池
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-涨停板行情-涨停股池
...
#### stock_zt_pool_strong_em - 东方财富网-行情中心-涨停板行情-强势股池
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-涨停板行情-强势股池
...
#### stock_zt_pool_sub_new_em - 东方财富网-行情中心-涨停板行情-次新股池
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-涨停板行情-次新股池
...
#### stock_zt_pool_zbgc_em - 东方财富网-行情中心-涨停板行情-炸板股池
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-涨停板行情-炸板股池
...
#### stock_qsjy_em - 东方财富网-数据中心-特色数据-券商业绩月报
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-特色数据-券商业绩月报
...
#### stock_hsgt_board_rank_em - 东方财富网-数据中心-沪深港通持股-板块排行
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-沪深港通持股-板块排行
- **限量**: 单次获取指定 symbol 和 indicator 的所有数据
- **输入参数**: 
...
#### stock_hsgt_hist_em - 东方财富网-数据中心-资金流向-沪深港通资金流向-沪深港通历史数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-资金流向-沪深港通资金流向-沪深港通历史数据
- **限量**: 单次获取指定 symbol 的所有数据
- **输入参数**: 
...
#### stock_hsgt_hold_stock_em - 东方财富网-数据中心-沪深港通持股-个股排行
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-沪深港通持股-个股排行
...
#### stock_hsgt_individual_detail_em - 东方财富网-数据中心-沪深港通-沪深港通持股-具体股票-个股详情
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-沪深港通-沪深港通持股-具体股票-个股详情
...
#### stock_hsgt_individual_em - 东方财富网-数据中心-沪深港通-沪深港通持股-具体股票
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-沪深港通-沪深港通持股-具体股票
...
#### stock_hsgt_institution_statistics_em - 东方财富网-数据中心-沪深港通-沪深港通持股-机构排行
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-沪深港通-沪深港通持股-机构排行
...
#### stock_hsgt_stock_statistics_em - 东方财富网-数据中心-沪深港通-沪深港通持股-每日个股统计
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-沪深港通-沪深港通持股-每日个股统计
...
#### stock_zh_ah_spot_em - 东方财富网-行情中心-沪深港通-AH股比价-实时行情, 延迟 15 分钟更新
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-沪深港通-AH股比价-实时行情, 延迟 15 分钟更新
- **限量**: 单次返回所有 A+H 上市公司的实时行情数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_hk_daily - 港股-历史行情数据, 可以选择返回复权后数据,更新频率为日频
- **数据源**: 新浪财经
- **功能**: 港股-历史行情数据, 可以选择返回复权后数据,更新频率为日频
...
#### stock_hk_famous_spot_em - 东方财富网-行情中心-港股市场-知名港股实时行情数据
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-港股市场-知名港股实时行情数据
- **限量**: 单次返回全部行情数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_hk_hist - 港股-历史行情数据, 可以选择返回复权后数据, 更新频率为日频
- **数据源**: 东方财富网
- **功能**: 港股-历史行情数据, 可以选择返回复权后数据, 更新频率为日频
...
#### stock_hk_hist_min_em - 东方财富网-行情首页-港股-每日分时行情
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情首页-港股-每日分时行情
...
#### stock_hk_indicator_eniu - 亿牛网-港股个股指标: 市盈率, 市净率, 股息率, ROE, 市值
- **数据源**: 未明确说明
- **功能**: 亿牛网-港股个股指标: 市盈率, 市净率, 股息率, ROE, 市值
- **限量**: 单次获取指定 symbol 和 indicator 的所有历史数据
- **输入参数**: 
...
#### stock_hk_main_board_spot_em - 港股主板的实时行情数据; 该数据有 15 分钟延时
- **数据源**: 东方财富网
- **功能**: 港股主板的实时行情数据; 该数据有 15 分钟延时
- **限量**: 单次返回港股主板的数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_hk_spot - 获取所有港股的实时行情数据 15 分钟延时
- **数据源**: 新浪财经
- **功能**: 获取所有港股的实时行情数据 15 分钟延时
...
#### stock_hk_spot_em - 所有港股的实时行情数据; 该数据有 15 分钟延时
- **数据源**: 东方财富网
- **功能**: 所有港股的实时行情数据; 该数据有 15 分钟延时
...
#### stock_hsgt_sh_hk_spot_em - 东方财富网-行情中心-沪深港通-港股通(沪>港)-股票；按股票代码排序
- **数据源**: 东方财富网
- **功能**: 东方财富网-行情中心-沪深港通-港股通(沪>港)-股票；按股票代码排序
- **限量**: 单次获取所有数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
- **数据源**: 东方财富网
- **功能**: 东方财富网-数据中心-新股数据-IPO审核信息-科创板
- **限量**: 单次返回所有历史数据
- **输入参数**: 
  - `-` (`-`): -
- **返回字段**: 
...
#### stock_zh_kcb_daily - 新浪财经-科创板股票历史行情数据
- **数据源**: 新浪财经
- **功能**: 新浪财经-科创板股票历史行情数据
...
#### stock_zh_kcb_report_em - 东方财富-科创板报告数据
- **数据源**: 东方财富网
- **功能**: 东方财富-科创板报告数据
...
#### stock_zh_kcb_spot - 新浪财经-科创板股票实时行情数据
- **数据源**: 新浪财经
- **功能**: 新浪财经-科创板股票实时行情数据
...
#### stock_us_daily - 美股历史行情数据，设定 adjust="qfq" 则返回前复权后的数据，默认 adjust="", 则返回未复权的数据，历史数据按日频率更新
- **数据源**: 新浪财经
- **功能**: 美股历史行情数据，设定 adjust="qfq" 则返回前复权后的数据，默认 adjust="", 则返回未复权的数据，历史数据按日频率更新
...
#### stock_us_famous_spot_em - 美股-知名美股的实时行情数据
- **数据源**: 东方财富网
- **功能**: 美股-知名美股的实时行情数据
...
#### stock_us_pink_spot_em - 美股粉单市场的实时行情数据
- **数据源**: 东方财富网
- **功能**: 美股粉单市场的实时行情数据
...
#### stock_us_spot - 新浪财经-美股; 获取的数据有 15 分钟延迟; 建议使用 ak.stock_us_spot_em() 来获取数据
- **数据源**: 新浪财经
- **功能**: 新浪财经-美股; 获取的数据有 15 分钟延迟; 建议使用 ak.stock_us_spot_em() 来获取数据
...
- **数据源**: 东方财富网
- **功能**: 东方财富-股票-财务分析-资产负债表-已退市股票-按报告期
...
- **数据源**: 东方财富网
- **功能**: 东方财富-股票-财务分析-现金流量表-已退市股票-按报告期
...
#### stock_financial_analysis_indicator - 新浪财经-财务分析-财务指标
- **数据源**: 新浪财经
- **功能**: 新浪财经-财务分析-财务指标
...
- **数据源**: 东方财富网
- **功能**: 东方财富-股票-财务分析-利润表-已退市股票-按报告期
